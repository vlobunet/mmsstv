...
{
private:
	int     m_Enabled;      // ѓЉѓ“ѓN‚М‹–‰В
	int     m_Polling;      // Ћь”gђ”ѓ|Ѓ[ѓЉѓ“ѓO
	BOOL	m_PTTEnabled;	// PTTѓRѓ“ѓgѓЌЃ[ѓ‹
	BOOL	m_1stSession;

	HWND	m_hLog;			// HamlogѓvѓЌѓOѓ‰ѓЂ‚Мѓnѓ“ѓhѓ‹
	HWND	m_hLogIn;		// Hamlog“ь—НѓEѓCѓ“ѓhѓE‚Мѓnѓ“ѓhѓ‹

	COPYDATASTRUCT  m_cds;	// ѓCѓ“ѓ^Ѓ[ѓtѓFЃ[ѓXЌ\‘ў‘М
	int		m_Count;		// ЉДЋ‹ѓJѓEѓ“ѓ^
	int     m_CStat;        // Џу‘Ф•ПЌXѓZѓ}ѓtѓH
	int     m_Count2;       // ѓ|Ѓ[ѓЉѓ“ѓOѓJѓEѓ“ѓ^

	HWND    m_hMain;        // ѓЃѓCѓ“‰ж–К‚МѓEѓCѓ“ѓhѓEѓnѓ“ѓhѓ‹
	HWND    m_hApp;         // ѓAѓvѓЉѓPЃ[ѓVѓ‡ѓ“‚МѓEѓCѓ“ѓhѓEѓnѓ“ѓhѓ‹
