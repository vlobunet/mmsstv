...
private:
	...
	double	m_lmsADJSC;			// ѓXѓPЃ[ѓ‹’Іђ®’l
	double	m_lmsErr;			// LMS ЊлЌ·ѓfЃ[ѓ^
	double	m_lmsMErr;			// LMS ЊлЌ·ѓfЃ[ѓ^ЃiЃ~‚QѓКЃj
	double  m_D;
public:
	int		m_Tap;
...
//	int		m_lmsDelay;			// LMS Delay
	...
	double	m_lmsMU2;			// LMS 2ѓК
	double	m_lmsGM;			// LMS ѓБ
	double	*H;					// ѓAѓvѓЉѓPЃ[ѓVѓ‡ѓ“ѓtѓBѓ‹ѓ^‚МЊWђ”
