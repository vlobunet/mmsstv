...
#define	BITDEBUG	0		// ѓLѓѓѓ‰ѓNѓ^’·‚М‘Є’и
#define	TXDDEBUG	0		// FSK‚МѓLѓѓѓ‰ѓNѓ^’·‚М‘Є’и
#define	FSKDEBUG	0		// FSK‚МѓfѓoѓbѓOѓ‚Ѓ[ѓh
#define	DEBUG_AFC	0		// AFC‚МѓeѓXѓg(+/-‚МЋь”gђ”)
...
private:
	double	m_c1;	// VCO‚М—“ѕ
	double	m_c2;	// ѓtѓЉЃ[ѓ‰ѓ“ѓjѓ“ѓOЋь”gђ”
	double	m_z;
...
class CNoise		// MЊn—сѓmѓCѓY N=22 (Tap=1)
{
private:
...
#define	HILLDOUBLEBUF	FALSE	// ‘¬“x‚Є‘¬‚ў‚Щ‚¤‚р‘I‘р
#define HILLTAP 48
class CHILL
{
public:
...
typedef struct {    // ѓЉѓsЃ[ѓ^—p‚МђЭ’и
	CIIRTANK    m_iirrep;
	CIIR        m_lpfrep;
	CLMS        m_lmsrep;
}REPSET;
