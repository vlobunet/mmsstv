...
//---------------------------------------------------------------------------
#define WAVE_TIMEOUT_EVENT  2000		// ѓoѓbѓtѓ@ѓЉѓNѓGѓXѓg‚Мѓ^ѓCѓЂѓAѓEѓg
#define	WAVE_FIFO_MAX	    32			// ЏzЉВѓoѓbѓtѓ@‚МЌЕ‘еЊВђ”
//---------------------------------------------------------------------------
class CWave
{
...
private:
	LPWAVEHDR    m_pInBuff[WAVE_FIFO_MAX];	// “ь—Нѓoѓbѓtѓ@
	LPWAVEHDR    m_pOutBuff[WAVE_FIFO_MAX];	// Џo—Нѓoѓbѓtѓ@
	WAVEFORMATEX m_OWFX;		// Џo—НѓtѓHЃ[ѓ}ѓbѓg
	WAVEFORMATEX m_IWFX;		// “ь—НѓtѓHЃ[ѓ}ѓbѓg
