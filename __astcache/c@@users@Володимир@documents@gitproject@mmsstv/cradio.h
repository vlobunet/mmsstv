...
typedef struct {
	...
	char	StrPort[32];	// ѓ|Ѓ[ѓg‚М–ј‘O
	int		BaudRate;		// ѓ{Ѓ[ѓЊЃ[ѓg
	...
	long	ByteWait;		// ѓoѓCѓgЉФ‚М‘—ђMѓEѓGѓCѓg
...
{
public:
	BOOL	m_CreateON;		// ѓNѓЉѓGѓCѓgѓtѓ‰ѓO
	DCB		m_dcb;			// ‚c‚b‚a
	HANDLE	m_fHnd;			// ѓtѓ@ѓCѓ‹ѓnѓ“ѓhѓ‹
	HWND	m_wHnd;			// ђe‚МѓEѓCѓ“ѓhѓEѓnѓ“ѓhѓ‹
	UINT	m_uMsg;
	UINT	m_ID;			// ѓЃѓbѓZЃ[ѓW‚М‚h‚c”ФЌ†
	volatile	int	m_Command;		// ѓXѓЊѓbѓh‚Ц‚МѓRѓ}ѓ“ѓh
	BOOL	m_TxAbort;		// ‘—ђM’†Ћ~ѓtѓ‰ѓO
	AnsiString	Name;
	CMMRadio	*m_pRadio;
